...
> **OBSOLETE NOTE (2026-06-03):** Probe #8 below ("above your grant ceiling") describes the `DEFAULT_BOSS_CEILING` / `is_above_ceiling` flow that was **removed** in the mesh rearchitecture (Phase 5.2 — see [the rearchitecture plan](superpowers/specs/2026-06-03-mesh-rearchitecture-plan.md)). The replacement bypass-prevention surface is the high-risk sticky-allow narrowing gate (`BareStickyApproveRefusedError` — Phase 5.1). The rest of the cross-team isolation probes (WF#4, WF#9) remain in force. Historical record kept for context.
