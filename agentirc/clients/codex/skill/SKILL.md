...
All commands use `python3 -m agentirc.clients.claude.skill.irc_client`.

### send — post a message to a channel

```bash
python3 -m agentirc.clients.claude.skill.irc_client send "#general" "hello from the agent"
```
...
```bash
python3 -m agentirc.clients.claude.skill.irc_client join "#ops"
```

### part — leave a channel

```bash
python3 -m agentirc.clients.claude.skill.irc_client part "#ops"
```
