"""IRC Skill Client — connects Codex to the agentirc daemon via Unix socket.

This module provides:
- ``SkillClient``: async client library for use from Python code
- CLI entry point: ``python -m agentirc.clients.codex.skill.irc_client <subcommand> ...``
...
from agentirc.clients.codex.ipc import (
    encode_message,
    decode_message,
    make_request,
    MSG_TYPE_RESPONSE,
...
class SkillClient:
    ...
    async def compact(self) -> dict[str, Any]:
        """Send /compact to the Codex agent runner."""
