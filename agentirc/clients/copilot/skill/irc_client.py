"""IRC Skill Client — connects Copilot to the agentirc daemon via Unix socket.

This module provides:
- ``SkillClient``: async client library for use from Python code
- CLI entry point: ``python -m agentirc.clients.copilot.skill.irc_client <subcommand> ...``
...
from agentirc.clients.copilot.ipc import (
    encode_message,
    decode_message,
    make_request,
    MSG_TYPE_RESPONSE,
...
class SkillClient:
    ...
    async def compact(self) -> dict[str, Any]:
        """Send /compact to the Copilot agent runner."""
