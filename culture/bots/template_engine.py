"""culture.bots.template_engine — thin alias of agentirc.bots.template_engine (issue #445 cutover).

The in-tree implementation now lives in agentirc.bots. This module makes
culture.bots.template_engine resolve to the single agentirc source, so EVERY symbol —
