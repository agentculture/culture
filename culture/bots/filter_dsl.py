"""culture.bots.filter_dsl — thin alias of agentirc.bots.filter_dsl (issue #445 cutover).

The in-tree implementation now lives in agentirc.bots. This module makes
culture.bots.filter_dsl resolve to the single agentirc source, so EVERY symbol —
