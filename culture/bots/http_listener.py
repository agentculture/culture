"""culture.bots.http_listener — thin alias of agentirc.bots.http_listener (issue #445 cutover).

The in-tree implementation now lives in agentirc.bots. This module makes
culture.bots.http_listener resolve to the single agentirc source, so EVERY symbol —
