"""culture_core.bots.bot — thin alias of agentirc.bots.bot (issue #445 cutover).

The in-tree implementation now lives in agentirc.bots. This module makes
culture_core.bots.bot resolve to the single agentirc source, so EVERY symbol —
...
from agentirc.bots import bot as _agentirc_module
