"""culture_core.bots.config — thin alias of agentirc.bots.config (issue #445 cutover).

The in-tree implementation now lives in agentirc.bots. This module makes
culture_core.bots.config resolve to the single agentirc source, so EVERY symbol —
...
from agentirc.bots import config as _agentirc_module
