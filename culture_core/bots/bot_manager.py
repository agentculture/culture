"""culture_core.bots.bot_manager — thin alias of agentirc.bots.bot_manager (issue #445 cutover).

The in-tree implementation now lives in agentirc.bots. This module makes
culture_core.bots.bot_manager resolve to the single agentirc source, so EVERY symbol —
