...
# _maybe_forward_to_steward (culture_core.cli.__init__).
...
def _get_bundled_admin_skill_path() -> str:
    ...
    return os.path.join(
        os.path.dirname(culture_core.__file__), "skills", "culture", _SKILL_FILENAME
    )
...
def _get_bundled_communicate_dir() -> str:
    ...
    return os.path.join(os.path.dirname(culture_core.__file__), "skills", "communicate")
