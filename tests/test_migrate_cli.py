...
def test_migrate_creates_server_yaml_and_culture_yamls(tmp_path):
    ...
    from culture_core.config import load_culture_yaml, load_server_config
...
""")
    ...
    from culture_core.cli.agents import _cmd_migrate
...
""")
    ...
    assert "already in manifest format" in exc_info.value.message
