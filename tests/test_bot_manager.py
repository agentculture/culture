...
async def test_start_swallows_listener_oserror(server, tmp_path, monkeypatch, caplog):
    ...
    monkeypatch.setattr("culture_core.bots.http_listener.HttpListener.start", _bad_start)
...
async def test_load_bots_sets_starting_guard_around_bot_start(
    ...
    from culture_core.bots.bot import Bot as _Bot
...
async def test_load_system_bots_skips_duplicate(server, monkeypatch, caplog):
    ...
    monkeypatch.setattr(
        "culture_core.bots.system.discover_system_bots",
...
async def test_load_system_bots_reads_server_config(server, monkeypatch):
    ...
    monkeypatch.setattr("culture_core.bots.system.discover_system_bots", _capture)
