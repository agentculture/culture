...
def test_archive_agent():
    ...
    from culture_core.clients.claude.config import (
        AgentConfig,
        DaemonConfig,
        ServerConnConfig,
        archive_agent,
...
def test_archive_bot():
    ...
    from culture_core.bots.config import BotConfig, load_bot_config, save_bot_config
...
def test_agent_config_backward_compat():
    ...
    from culture_core.clients.claude.config import load_config
...
def test_cli_create_replaces_archived_agent(monkeypatch):
    ...
    from culture_core.cli.agents import _cmd_create
    from culture_core.clients.claude.config import (
        AgentConfig,
        DaemonConfig,
        ServerConnConfig,
...
def test_cli_delete_removes_agent():
    ...
    from culture_core.cli import _build_parser
    from culture_core.cli.agents import _cmd_delete
    from culture_core.clients.claude.config import (
        AgentConfig,
        DaemonConfig,
        ServerConnConfig,
...
def test_archive_agent_preserves_backend_fields():
    ...
    from culture_core.clients.claude.config import archive_agent
...
def test_unarchive_agent_preserves_backend_fields():
    ...
    from culture_core.clients.claude.config import archive_agent, unarchive_agent
...
def test_rename_agent_preserves_backend_fields():
    ...
    from culture_core.clients.claude.config import rename_agent
...
def test_rename_server_preserves_backend_fields():
    ...
    from culture_core.clients.claude.config import rename_server
...
def test_archive_server_preserves_backend_fields():
    ...
    from culture_core.clients.claude.config import archive_server
...
def test_add_agent_preserves_backend_fields():
    ...
    from culture_core.clients.claude.config import AgentConfig, add_agent_to_config
