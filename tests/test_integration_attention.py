...
from culture_core.clients.shared.attention import Band
...
# parsing in culture_core/clients/claude/config.py. With hold_s=2 and a
...
async def test_mention_bumps_attention_band(server, make_client, tmp_path, monkeypatch):
    ...
    try:
        ...
        # culture_core/clients/shared/irc_transport.py.
